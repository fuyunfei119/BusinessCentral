...
////            "|| execution(* com.example.businesscentral.Dao.BusinessCentral*.Delete(..)) " +
////            "|| execution(* com.example.businesscentral.Dao.BusinessCentral*.Init(..))")
////    public void OnTriggerTableEvent() {
////    }
//
//
//    @Around("execution(* com.example.businesscentral.Dao.BusinessCentral*.Init(..,Object)) && args(o)")
//    public Object OnDoTest(ProceedingJoinPoint pjp,Object o) throws Throwable {
//
